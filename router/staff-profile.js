...
router.get('/fetchbyInstitution', async (req, res) => {
	const response = await staffProfileController.fetchbyInstitution(req.query.institution);
	res.send(response);
	console.log('/fetchbyInstitution',response);
})
